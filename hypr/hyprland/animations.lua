...
hl.curve("easeInQuint",    { type = "bezier", points = { {0.76, 0.05}, {0.85, 0.06} } })
...
hl.animation({ leaf = "specialWorkspaceIn",  enabled = true,  speed = 2.01, bezier = "easeOutQuint", style = "slidevert"})
hl.animation({ leaf = "specialWorkspaceOut", enabled = true,  speed = 1.15, bezier = "easeInQuint",  style = "slidevert"})
